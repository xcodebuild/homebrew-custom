cask "codeterminal" do
  ...
  if Hardware::CPU.intel?
    url "https://nightly.link/xcodebuild/CodeTerminal/workflows/release/release/CodeTerminalNightly-macOS-Intel.zip"
  else
    url "https://nightly.link/xcodebuild/CodeTerminal/workflows/release/release/CodeTerminalNightly-macOS-M1.zip"
  end
  name "CodeTerminal"
